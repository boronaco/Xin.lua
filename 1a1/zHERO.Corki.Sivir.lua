...
local 	ADCMenu = MenuElement({id = "ADCMainExt", name = "ADC"..myHero.charName, type = MENU })
...
function Corki:Menu()
	-- COMBO
	ADCMenu.Combo:MenuElement({id = "useQ", name = "Use Q", value = true})
	ADCMenu.Combo:MenuElement({id = "useW", name = "Use W", value = false})
	ADCMenu.Combo:MenuElement({id = "useE", name = "Use E", value = false})
	ADCMenu.Combo:MenuElement({id = "useR", name = "Use R", value = true})
	...
	-- HARASS
	ADCMenu.Harass:MenuElement({id = "useQ", name = "Use Q", value = false, leftIcon = self.spellIcons.Q})
	ADCMenu.Harass:MenuElement({id = "manaQ", name = " Q | Mana-Manager", value = 70, min = 0, max = 100, step = 1})
	ADCMenu.Harass:MenuElement({id = "useE", name = "Use E", value = false, leftIcon = self.spellIcons.E})
	ADCMenu.Harass:MenuElement({id = "manaE", name = " E | Mana-Manager", value = 80, min = 0, max = 100, step = 1})
	ADCMenu.Harass:MenuElement({id = "useR", name = "Use R", value = false, leftIcon = self.spellIcons.R})
	ADCMenu.Harass:MenuElement({id = "useRX", name = "Safe X amount of R stacks", value = 4, min = 0, max = 7, step = 1})
	ADCMenu.Harass:MenuElement({id = "manaR", name = " R | Mana-Manager", value = 40, min = 0, max = 100, step = 1})

	-- KILLSTEAL
	ADCMenu.Killsteal:MenuElement({id = "useQ", name = "Use Q to killsteal", value = true})
	ADCMenu.Killsteal:MenuElement({id = "useR", name = "Use R to killsteal", value = true})
...
function Sivir:Menu()
	ADCMenu.Combo:MenuElement({id = "useQ", name = "Use Q", value = true})
	ADCMenu.Combo:MenuElement({id = "useW", name = "Use W", value = true})
	ADCMenu.Combo:MenuElement({id = "useR", name = "Use R", value = true})
	ADCMenu.Combo:MenuElement({id = "useRonXE", name = " If X enemies around", value = 3, min = 1, max = 5, step = 1 })
	ADCMenu.Combo:MenuElement({id = "useRonXA", name = " If X allies around", value = 2, min = 0, max = 4, step = 1 })
	
	-- ADCMenu.Combo:MenuElement({id = "Orb", name = "Use ADC in 2017 Orbwalker", value = true})

	ADCMenu.Harass:MenuElement({id = "useQ", name = "Use Q", value = true})
	ADCMenu.Harass:MenuElement({id = "manaQ", name = " Q | Mana-Manager", value = 60, min = 0, max = 100, step = 1})
	ADCMenu.Harass:MenuElement({id = "useW", name = "Use W", value = true})
	ADCMenu.Harass:MenuElement({id = "manaW", name = " W | Mana-Manager", value = 0, min = 0, max = 100, step = 1})

	ADCMenu.Killsteal:MenuElement({id = "useQ", name = "Use Q", value = true})
	...
	ADCMenu.Misc:MenuElement({id = "autoE", name = "Use auto E agains skillshots", value = true})
	ADCMenu.Misc:MenuElement({id = "saveDelay", name = "E | Safety delay", value = 250, min = 150, max = 500, step = 10})
	ADCMenu.Misc:MenuElement({id = "autoQ", name = "Use auto Q on Immobile", value = true})
	ADCMenu.Misc:MenuElement({id = "manaQ", name = " Q on Immobile | Mana-Manager", value = 0, min = 0, max = 100, step = })
