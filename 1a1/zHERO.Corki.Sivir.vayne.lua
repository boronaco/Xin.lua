...
function Corki:Menu()
	...
	ADCMenu.Combo:MenuElement({id = "useE", name = "Use E", value = true})
	...
	ADCMenu.Harass:MenuElement({id = "useE", name = "Use E", value = false})
	ADCMenu.Harass:MenuElement({id = "manaE", name = " E | Mana-Manager", value = 80, min = 0, max = 100, step = 1})
	ADCMenu.Harass:MenuElement({id = "useR", name = "Use R", value = true})
...
function Sivir:Menu()
	...
	ADCMenu.Harass:MenuElement({id = "manaW", name = " W | Mana-Manager", value = 40, min = 0, max = 100, step = 1})
