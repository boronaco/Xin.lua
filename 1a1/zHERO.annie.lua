...
function Annie:LoadMenu()
	...
	self.Menu.Ripper.Combo:MenuElement({id = "R", name = "Use R", value = false, leftIcon = Icons.R})
	self.Menu.Ripper.Combo:MenuElement({id = "RS", name = "R just if have stun", value = false,})
