...
--Main Menu
	...
	self.Menu = MenuElement({type = MENU, id = "Riven_Tocsin", name = "Riven"})
...
--Combo Settings Menu
	...
	self.Menu.Combo:MenuElement({id = "UseR", name = "Use R", value = false})
...
--Harass Settings Menu
	...
	self.Menu.Harass:MenuElement({id = "UseQ", name = "Use Q", value = false})
	self.Menu.Harass:MenuElement({id = "UseW", name = "Use W", value = false})
	self.Menu.Harass:MenuElement({id = "UseE", name = "Use E", value = false})
	self.Menu.Harass:MenuElement({id = "UseR", name = "Use R", value = false})
...
--Flee oR Chase
	...
	self.Menu.Flee:MenuElement({id = "UseQ", name = "Use Q", value = false})
	self.Menu.Flee:MenuElement({id = "UseW", name = "Use W", value = false})
	self.Menu.Flee:MenuElement({id = "UseE", name = "Use E", value = false})
