...
-- Combo Sub-Menu
	TartoGnar.Menu.Combo:MenuElement({id = "UseQ", name = "Use Q", value = true})
	TartoGnar.Menu.Combo:MenuElement({id = "UseQM", name = "Use Q MEGA", value = true})
	TartoGnar.Menu.Combo:MenuElement({id = "UseWM", name = "Use W", value = true,})
	TartoGnar.Menu.Combo:MenuElement({id = "UseR", name = "[SOON]Use R", value = false})
	TartoGnar.Menu.Combo:MenuElement({id = "UseRTarget", name = "[SOON]Minimum targets R", value = 2, min = 1, max = 5, step = 1})
-- LaneClear Sub-Menu
	TartoGnar.Menu.LaneClear:MenuElement({id = "UseQ", name = "[SOON]Use Q", value = true})
	TartoGnar.Menu.LaneClear:MenuElement({id = "UseQM", name = "[SOON]Usif myHero.charName ~= "Gnar" then return end
...
-- LaneClear Sub-Menu
	TartoGnar.Menu.LaneClear:MenuElement({id = "UseQ", name = "[SOON]Use Q", value = true})
	TartoGnar.Menu.LaneClear:MenuElement({id = "UseQM", name = "[SOON]Use Q MEGA", value = true})
	TartoGnar.Menu.LaneClear:MenuElement({id = "UseWM", name = "[SOON]Use W", value = true})
-- Harass Sub-Menu
	TartoGnar.Menu.Harass:MenuElement({id = "UseQ", name = "Use Q", value = true})
...
-- Draw Sub-Menu
	...
	TartoGnar.Menu.Draw:MenuElement({id = "DrawQ", name = "Draw Q Range", value = true})
	TartoGnar.Menu.Draw:MenuElement({id = "DrawW", name = "Draw W Range", value = false})
	TartoGnar.Menu.Draw:MenuElement({id = "DrawR", name = "Draw R Range", value = false})
-- Killsteal Sub-Menu
	TartoGnar.Menu.Killsteal:MenuElement({id = "StealQ", name = "Killsteal Q", value = true})
	TartoGnar.Menu.Killsteal:MenuElement({id = "StealQM", name = "Killsteal Q MEGA", value = false})
	TartoGnar.Menu.Killsteal:MenuElement({id = "StealR", name = "Killsteal R", value = false})
