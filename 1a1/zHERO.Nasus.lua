...
function Nasus:LoadMenu()
  ...
  self.Menu.Combo:MenuElement({id = "R", name = "Auto R", value = false})
  ...
  self.Menu.Harass:MenuElement({id = "E", name = "Use E", value = false})
  ...
  self.Menu.cs:MenuElement({id = "E", name = "Use E", value = false})
  ...
  self.Menu.Clear:MenuElement({id = "Q", name = "Use Q", value = false})
  self.Menu.Clear:MenuElement({id = "E", name = "Use E", value = false})
...
function Nasus:Harass()
  local target = GetTarget(650)
  if target == nil then return end
  if self.Menu.Harass.Q:Value() and myHero.pos:DistanceTo(target.pos) <= myHero.range + 150 and Ready(_Q) and myHero.mana/myHero.maxMana >= self.Menu.Harass.Mana:Value() / 100 then
    Control.CastSpell(HK_Q)
  end
  if target == nil then return end
